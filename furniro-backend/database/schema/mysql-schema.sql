...
CREATE TABLE `customer_address` (
  ...
  PRIMARY KEY (`id`),
  KEY `customer_address_user_id_foreign` (`user_id`),
  CONSTRAINT `customer_address_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customer_details` (
  ...
  `phone_details` varchar(255) NOT NULL,
  ...
  CONSTRAINT `customer_details_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `product_discount_inventory_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `product_discount_inventory_categories` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `prod_disc_inv_cat_prod_cat_id_fk` (`product_categories_id`),
  KEY `prod_disc_inv_cat_prod_id_fk` (`product_id`),
  KEY `prod_disc_inv_cat_qty_id_fk` (`quantity_id`),
  KEY `prod_disc_inv_cat_disc_id_fk` (`discount_id`),
  CONSTRAINT `prod_disc_inv_cat_disc_id_fk` FOREIGN KEY (`discount_id`) REFERENCES `product_discounts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `prod_disc_inv_cat_prod_cat_id_fk` FOREIGN KEY (`product_categories_id`) REFERENCES `product_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `prod_disc_inv_cat_prod_id_fk` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `prod_disc_inv_cat_qty_id_fk` FOREIGN KEY (`quantity_id`) REFERENCES `product_quantities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
